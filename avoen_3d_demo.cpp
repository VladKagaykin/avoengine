...
void display() {
    ...
    draw_floor();
    entity->draw(cam_angle, cam_x, CAM_HEIGHT, cam_z);
...
int main(int argc, char** argv) {
    ...
    entity = new pseudo_3d_entity(0, 0.5f, 0, 0, 0, textures, 8, verts);
    ...
    // play_sound_3d_loop("src/radio/radio.wav", 0, 0.5f, 0, 1.5f);
    play_white_noise_3d(0, 0.5f, 0);
